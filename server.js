...
const promise = mongoose.connect("mongodb://130.211.224.114/image_scraping", {
   useMongoClient: true   
}); 
...
.then(function (response) {
	console.log('first 10 results from bing', JSON.stringify(response));
	return res.json({responseCode:200,responseMessage:"Success",data:response})

}).catch(function(err) {
	console.log('err',err);
	return res.json({responseCode:404,responseMessage:"Failure",data:err})
})
     //  bing.list({
       ...
       // })
       // .then(function (response) {
         //   console.log(' results from google',JSON.stringify(response));
           //             return res.json({responseCode:200,responseMessage:"Success",data:response})
      //  }).catch(function(err) {
        //    console.log('err==============+>>>>>>>>>>>>>>>>>>>>', err);
